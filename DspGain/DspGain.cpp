...
void DspGain::SetGain(float gain)
{
...
void DspGain::Process_(DspSignalBus& inputs, DspSignalBus& outputs)
{
...
bool DspGain::ParameterUpdating_(int index, DspParameter const& param)
{
    if (index == pGain)
    {
